...
int buyCard(int supplyPos, struct gameState *state) {
  ...
  if (state->numBuys < 1){
    ...
    gainCard(supplyPos, state, 0, who); //card goes in discard, this might be wrong.. (2 means goes into hand, 0 goes xinto discard)
...
/////////////////////////
 peformsmithyActions(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus, int drawntreasure,int currentPlayer,int cardDrawn,int temphand[],int z3,int i3)
 {
      //+3 Cards
      for (i3 = 0; i3 < 3; i3++)
  {
